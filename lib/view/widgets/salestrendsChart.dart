...
class SalesTrendsChart extends StatelessWidget {
      ...
      children: [
        ...
        Expanded(
          child: Obx(() {
            ...
            //                   final month = salesController.getMonthName(
                  ...
                  xValueMapper: (data, index) {
                    switch (salesController.selectedPeriod.value) {
                      ...
                      case 'week':
                        ...
                        return weekdays[data['weekday'] - 1];
                      default:
                        return salesController.getMonthName(
                            data['month'].toString().substring(5));
                    }
                  },
                  yValueMapper: (data, index) =>
                      (data['sales'] as num?)?.toDouble() ?? 0.0,
  ...
  Widget _buildPeriodButton(SalesController controller, String period) {
    return Obx(() {
      final isSelected =
          controller.selectedPeriod.value == period.toLowerCase();
      return TextButton(
